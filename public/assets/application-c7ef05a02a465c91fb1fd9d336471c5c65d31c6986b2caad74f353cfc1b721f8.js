...
(function() {
  $(document).ready(function() {
    var offset, scroll_start, startchange;
    scroll_start = 0;
      ...
      $(document).scroll(function() {
        ...
        if (scroll_start > offset.top) {
          ...
          if ($('#navbrand_image').length === 0) {
            $("<a href='/' class='brand_link' style = 'display:inline-block; background-color: #000000'><img src='/assets/kasosa-white.png' alt='KaSoSa!' class='img-responsive' id='navbrand_image' style='width: 100%; height: 100%;'/></a>").insertAfter('.brand_logo');
          }
        } else {
